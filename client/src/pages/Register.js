      ...
      >
        <Card title="Signup">
          <Form className="registerForm">
            <Form.Item
              label="Username"
              validateStatus={helpUsername ? "error" : "success"}
              help={helpUsername}
              colon={false}
              {...formItemLayout}
            >
              <Input
                ...
                id="username"
                onChange={(e) => saveValues(e)}
                onBlur={(e) => onBlurValues(e)}
                value={username}
              />
            </Form.Item>
            <Form.Item
              ...
              {...formItemLayout}
              help={helpEmail}
              validateStatus={helpEmail ? "error" : "success"}
            >
              <Input
                placeholder="email"
                id="email"
            ...
            <Form.Item
              ...
              {...formItemLayout}
              help={helpPassword}
              validateStatus={helpPassword ? "error" : "success"}
            >
              <Input.Password
            ...
            <Form.Item
              ...
              colon={false}
              {...formItemLayout}
              help={helpConfirmPassword}
              validateStatus={helpConfirmPassword ? "error" : "success"}
            >
              <Input.Password
            ...
            <Form.Item label="Pick Theme" colon={false} {...formItemLayout}>
